...
function ParseLua(src)
	...
	local function CreateScope(parent)
		...
		function scope:ObfuscateVariables()
			for _, var in pairs(scope.LocalList) do
				local id = "AXR"--_G.customVar
				repeat
					local chars = "1l1IIIlIlll1IIIII1l1l1l1l1l1l1l1IIIIIIIlIll1l1l1l1l1l1l1l1l1IIIlIllll1l1l1l1l1l1"
                    local chars2 = "1lI1l1l1l1l1111l1l1l1l1lIIIIIII1l1l1l1lIIII1l1l1l1IIIlIlIlI"
                    local n = math.random(1, #chars)
                    id = id .. chars:sub(n, n)
                     local n = math.random(1, #chars2)
                     id = id .. chars2:sub(n, n)
